...
if ( ! class_exists( 'Bsmaps_VC_Lmap' ) ) {
	/**
	 * BMI shortcode class
	 *
	 * @return void
	 */
	class Bsmaps_VC_Lmap extends WPBakeryShortCode {
		/**
		 * Slug
		 *
		 * @var string
		 */
		protected $slug = 'bsmaps-vc-lmap';
		...
		private function set_name() {
			$this->name_escaped = esc_html__( 'BS Leaflet Map', 'bsmaps' );
		}
